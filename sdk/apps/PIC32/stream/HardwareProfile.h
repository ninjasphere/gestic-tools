...
#define LED_TOUCH_BIT BIT_0
#define LED_GESTURE_BIT BIT_2


extern inline void __attribute__((always_inline)) SetLEDDirection(void)
{
    PORTSetPinsDigitalOut(LED_IOPORT, (LED_BUSY_BIT | LED_TOUCH_BIT |
                                       LED_GESTURE_BIT));
}
...
extern inline void __attribute__((always_inline)) TurnLEDOn(USBSK_LED led)
{
    ...
    if(led == LED_TOUCH) /* LED1 */
        PORTSetBits(LED_IOPORT, LED_TOUCH_BIT);

    if(led == LED_GESTURE) /* LED3 */
        PORTSetBits(LED_IOPORT, LED_GESTURE_BIT);
}
...
extern inline void __attribute__((always_inline)) TurnLEDOff(USBSK_LED led)
{
    ...
    if(led == LED_TOUCH) /* LED1 */
        PORTClearBits(LED_IOPORT, LED_TOUCH_BIT);

    if(led == LED_GESTURE) /* LED3 */
        PORTClearBits(LED_IOPORT, LED_GESTURE_BIT);
}
...
extern inline void __attribute__((always_inline)) ToggleLED(USBSK_LED led)
{
    ...
    if(led == LED_TOUCH) /* LED1 */
        PORTToggleBits(LED_IOPORT, LED_TOUCH_BIT);

    if(led == LED_GESTURE) /* LED3 */
        PORTToggleBits(LED_IOPORT, LED_GESTURE_BIT);
}

extern inline void __attribute__((always_inline)) TurnLEDAllOn(void)
{
    PORTSetBits(LED_IOPORT, LED_BUSY_BIT); /* LED2 */
    PORTSetBits(LED_IOPORT, LED_TOUCH_BIT); /* LED1 */
    PORTSetBits(LED_IOPORT, LED_GESTURE_BIT); /* LED3 */
}

extern inline void __attribute__((always_inline)) TurnLEDAllOff(void)
{
    PORTClearBits(LED_IOPORT, LED_BUSY_BIT); /* LED2 */
    PORTClearBits(LED_IOPORT, LED_TOUCH_BIT); /* LED1 */
    PORTClearBits(LED_IOPORT, LED_GESTURE_BIT); /* LED3 */
}
